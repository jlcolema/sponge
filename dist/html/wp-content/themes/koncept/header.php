...
<body id="body" <?php body_class( 'no-touch no-js ' . get_option( 'krown_menu_sticky', 'no-sticky' ) ); ?> <?php echo get_option( 'krown_menu_sticky', 'no-sticky' ) == 'sticky' ? ' style=""' : '' ;?>>
	...
	<header id="header">
		...
		<div class="wrap">
			...
			<div id="menu-class" class="<?php echo get_option( 'krown_menu_style', 'menu-two' ); ?>">
				...
				<?php } elseif ( is_singular( 'portfolio' ) ) { ?>
					...
					<?php custom_logo_url( 'portfolio_category', $project_parent, __( 'Back to all projects', 'krown' ) . krown_svg( 'close' ) ); ?>
				...
				<nav id="main-menu">
					...
					<?php if ( get_option( 'krown_menu_style', 'menu-one' ) == 'menu-one' || get_option( 'krown_menu_style' ) == 'menu-two' ) : ?>
						...
						<div id="menu-text">
							...
							<?php echo do_shortcode( get_option( 'krown_menu_text' ) ); ?>
				...
				<div id="menu-closer-wrap">

					<div id="menu-closer-inner-wrap">

						<div id="menu-closer-inner-inner-wrap">

							<a id="menu-closer" href="#">

								<?php echo krown_svg( 'close' ); ?>
