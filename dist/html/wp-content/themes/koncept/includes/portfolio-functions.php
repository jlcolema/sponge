...
function custom_logo_url( $taxonomy = 'portfolio_category', $page_id = null, $back_text = '' ){

	$return_to_landing_page = isset( $_GET['id'] ) ? $_GET['id'] : get_option( 'krown_portfolio_page', '' );

	$html .= '<a id="logo" href="' . get_permalink( $return_to_landing_page ) . '">';
